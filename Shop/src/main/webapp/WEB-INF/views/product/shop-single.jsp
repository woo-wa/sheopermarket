		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<img
							src="${pageContext.request.contextPath}/resources/images/title/${detail.picture_url}"
							alt="Image" class="img-fluid">
					</div>
					<div class="col-md-6">
						<h2 class="text-black">${detail.product_name }</h2>
						...
						<p>
							<a href="${path}/shop/product/cart.do"
						...
						<div class="nonloop-block-3 owl-carousel">
							<div class="item">
								<div class="block-4 text-center">
									<figure class="block-4-image">
										<img
											src="${pageContext.request.contextPath}/resources/images/cloth_1.jpg"
							...
							<div class="item">
								<div class="block-4 text-center">
									<figure class="block-4-image">
										<img
											src="${pageContext.request.contextPath}/resources/images/shoe_1.jpg"
											alt="Image placeholder" class="img-fluid">
									</figure>
									<div class="block-4-text p-4">
										<h3>
							...
							<div class="item">
								<div class="block-4 text-center">
									<figure class="block-4-image">
										<img
											src="${pageContext.request.contextPath}/resources/images/cloth_2.jpg"
											alt="Image placeholder" class="img-fluid">
									</figure>
									<div class="block-4-text p-4">
										<h3>
							...
							<div class="item">
								<div class="block-4 text-center">
									<figure class="block-4-image">
										<img
											src="${pageContext.request.contextPath}/resources/images/cloth_3.jpg"
											alt="Image placeholder" class="img-fluid">
									</figure>
									<div class="block-4-text p-4">
										<h3>
